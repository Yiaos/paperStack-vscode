---
description: Implement a feature/fix based on a provided spec sheet with systematic task management
---

You are tasked with implementing a feature/fix based on a provided spec sheet. The spec is provided as: $ARGUMENTS
