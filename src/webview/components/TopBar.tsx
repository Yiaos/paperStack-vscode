  ...
  return (
    <div class="top-bar">
      <div class="session-info">
        <span class="session-title" style={{ "font-weight": 500, "font-size": "13px", color: "var(--foreground)", overflow: "hidden", "text-overflow": "ellipsis", "white-space": "nowrap" }}>
      ...
      <div class="top-bar-actions">
        ...
        <button class="icon-button" onClick={props.onOpenSettings} aria-label="设置" data-tooltip="设置" data-tooltip-pos="left">
